...
17. 实现了13
    ...
    - 对于经验利用的好，在训练过程中会多进行reward高的行为，而不会完全随机，都等可能的实行

    |                                       | besttrain                 | best                      | besttrain(Ours) | best(Ours)   |
    | ------------------------------------- | ------------------------- | ------------------------- | --------------- | ------------ |
    | Massive Moss Charger 草团子           |                           |                           |                 |              |
    | Crystal Guardian 白给守卫501(792) 618 | 2.682602 3 (16.327404 95) | 0.180630 1 (14.977085 85) | x               | 17.306405 98 |
    | False Knight 假骑士                   |                           |                           |                 |              |
    | Broken Vessel 大表哥 391 907 50-500   | 18.884274 93              | 19.162956 97              | 18.124176 92    | 18.526906 92 |
